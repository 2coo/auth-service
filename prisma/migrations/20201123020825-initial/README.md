# Migration `20201123020825-initial`

This migration has been generated by Tuvshinbayar Tuvhshinzul at 11/23/2020, 10:08:25 AM.
...
`oAuthResourceServerId` varchar(191)  ,
`createdAt` datetime(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
`updatedAt` datetime(3)  NOT NULL ,
...
`createdAt` datetime(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
`updatedAt` datetime(3)  NOT NULL ,
UNIQUE INDEX `oAuthAccessToken.jti_unique`(`jti`),
PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
...
`userId` varchar(191)  NOT NULL ,
`status` ENUM('VERIFIED', 'DISABLED')  NOT NULL DEFAULT 'VERIFIED',
`isUserCreatedBefore` boolean  NOT NULL ,
`createdAt` datetime(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
`updatedAt` datetime(3)  NOT NULL ,
UNIQUE INDEX `Identity.sub_unique`(`sub`),
PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
...
CREATE TABLE `_GroupTooAuthScope` (
`A` varchar(191)  NOT NULL ,
`B` varchar(191)  NOT NULL ,
UNIQUE INDEX `_GroupTooAuthScope_AB_unique`(`A`,
`B`),
INDEX `_GroupTooAuthScope_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
...
ALTER TABLE `oAuthScope` ADD FOREIGN KEY (`oAuthResourceServerId`) REFERENCES `oAuthResourceServer`(`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
ALTER TABLE `_GroupTooAuthScope` ADD FOREIGN KEY (`A`) REFERENCES `Group`(`id`) ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE `_GroupTooAuthScope` ADD FOREIGN KEY (`B`) REFERENCES `oAuthScope`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
+  User                User           @relation(fields: [userId], references: [id])
+  userId              String
+  status              IdentityStatus @default(VERIFIED)
