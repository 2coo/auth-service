# Migration `20201102115421-initial`

This migration has been generated by Tuvshinbayar Tuvhshinzul at 11/2/2020, 7:54:22 PM.
...
ALTER TABLE `User` ADD FOREIGN KEY (`userPoolId`) REFERENCES `UserPool`(`id`) ON DELETE SET NULL ON UPDATE CASCADE
